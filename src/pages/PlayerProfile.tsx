...
const PlayerProfile: React.FC = () => {
  ...
  // Public share removed 2026-07-15. Anon read of a minor's photo,
  // name, and stats behind a discoverable URL didn't sit right with
  // the Circle framing (recognition lives inside a loving group, not
  // in the open). Grandma/etc get invited to the Player Circle instead.
  // The /p/:playerId route + publicShare doc field stay in place so
  // any existing shared URL renders the friendly permissions-error
  // page rather than exposing data.
