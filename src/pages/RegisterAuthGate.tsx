          ...
          {mode === 'choose' && (
            <>
              <button
                ...
                disabled={busy}
                className="w-full py-3 rounded-xl font-bold text-sm bg-white text-slate-900 hover:bg-slate-100 disabled:opacity-50 flex items-center justify-center gap-2 theme-ok"
              >
