...
const Dashboard: React.FC = () => {
  ...
  if (hasAnyTeam && selectedTeamId && !selectedTeamIsMine) {
    ...
    return (
      <div className="min-h-screen bg-surface-base flex items-center justify-center text-ink-primary/60 text-sm">
        Loading your team…
      </div>
    );
  }
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="relative flex-shrink-0 w-[128px] h-[128px]">
            ...
            {/* Jersey pill: TOP-LEFT, landing in the empty quadrant
                ...
                because src/index.css:358 remaps bg-surface-elevated to
