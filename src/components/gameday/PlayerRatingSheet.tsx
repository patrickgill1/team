      ...
      >
        ...
        <div className="sticky bottom-0 bg-surface-elevated/95 backdrop-blur border-t border-line-default/10 px-5 py-3 flex items-center gap-3">
          ...
          <button
            ...
            className="flex-1 px-4 py-2.5 rounded-lg bg-brand-primary text-white text-xs font-extrabold uppercase tracking-widest hover:bg-brand-primary-soft hover:text-ink-primary disabled:opacity-60 transition"
          >
