...
function RsvpButton({ tone, active, label, onClick }: {
  ...
  const inactiveStyles = 'bg-black/50 text-white/90 ring-1 ring-white/10 backdrop-blur-md hover:bg-black/60 theme-ok';
  return (
    <button
      type="button"
      onClick={onClick}
...
function MiniRsvpPill({ tone, active, label, onClick }: {
  ...
  const inactiveStyles = 'bg-black/50 text-white/85 ring-1 ring-white/10 hover:bg-black/65 theme-ok';
  return (
    <button
      type="button"
      onClick={onClick}
