        ...
        <div className="grid grid-cols-3 sm:grid-cols-4 gap-1.5">
          {photos.slice(0, 8).map((p, idx) => (
            <button
              ...
              className="relative aspect-square rounded-lg overflow-hidden bg-gray-100 ring-1 ring-gray-200 hover:opacity-90 active:scale-95 transition theme-ok"
            >
              <img
                src={p.url}
          ...
          {photos.length > 8 && (
            <button
              ...
              className="relative aspect-square rounded-lg overflow-hidden bg-surface-base/80 text-white flex items-center justify-center text-sm font-bold"
            >
              +{photos.length - 8}
            </button>
          )}
