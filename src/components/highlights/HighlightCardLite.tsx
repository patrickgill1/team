...
const HighlightCardLite: React.FC<Props> = ({ clip, players, onOpen, fullWidth, onFeature: _onFeature }) => {
  ...
  return (
    ...
    >
      ...
      {/* Feature chip removed 2026-09-13: it sat on every coach-
          uploaded card, on every grid, and read as visual noise
          Patrick called out ("kill the FEATURE button on every tile").
          Coaches can still feature clips from the lightbox editor
          (editingFeaturedByCoach toggle), which is the natural place
          for it — you're already looking at the specific clip. The
          onFeature prop is kept for API stability but ignored here;
