...
const Highlights: React.FC = () => {
  ...
  if (filtered.length === 0) {
    return (
      <div className="min-h-[100dvh] bg-black text-white flex flex-col items-center justify-center px-6 text-center theme-ok">
  ...
  return (
    <div className="relative bg-black text-white theme-ok">
      ...
      <div className="fixed top-0 left-0 right-0 lg:left-64 z-30 pointer-events-none">
        <div className="flex items-center gap-2 px-4 pt-3 pb-2 bg-gradient-to-b from-black/80 via-black/40 to-transparent pointer-events-auto">
          ...
          <select
            ...
            className="bg-black/60 backdrop-blur border border-line-default/20 rounded-lg px-2.5 py-1 text-xs text-white focus:outline-none focus:border-line-default/50 theme-ok"
          >
            ...
            >
              ...
              {i < filtered.length - 1 && (
                <div className="absolute bottom-2 left-1/2 -translate-x-1/2 z-20 pointer-events-none">
                  <div className="px-3 py-1.5 rounded-full bg-black/60 ring-1 ring-line-default/15 backdrop-blur text-white text-[10px] font-extrabold tracking-widest uppercase flex items-center gap-1.5 animate-bounce theme-ok">
                    <svg className="w-3 h-3" fill="none" stroke="currentColor" strokeWidth={2.5} strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24"><polyline points="6 9 12 15 18 9"/></svg>
                    Swipe up
                  </div>
                </div>
