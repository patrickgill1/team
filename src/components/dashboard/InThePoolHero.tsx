      ...
      <div className="max-w-3xl mx-auto">
                ...
                <div key={k.registrationId} className={`rounded-2xl p-4 ring-1 ${tone.bg} ${tone.ring}`}>
                  <div className="flex items-center justify-between gap-3 mb-2">
                    <div className="min-w-0">
                      ...
                      {k.ageGroup && <div className="text-[11px] font-bold uppercase tracking-widest text-ink-primary/65">{k.ageGroup}</div>}
                    </div>
        ...
        {overallVibe === 'in_pool' && (
          <div className="mt-6 bg-line-default/[0.03] ring-1 ring-line-default/10 rounded-2xl p-5">
            ...
            <p className="text-[11px] text-ink-primary/65 mt-3 italic">Hang tight. You can close this app and we'll email you when something changes.</p>
          </div>
        )}
      </div>
    </div>
