    ...
    <div className="min-h-screen bg-gradient-to-br from-surface-base via-surface-elevated to-vignette-deep px-4 py-10 sm:py-16">
      <div className="max-w-md mx-auto">
        <div className="text-center mb-8">
          ...
          <h1 className="text-4xl sm:text-5xl font-black text-white leading-tight">  // theme-ok: legacy hardcoded color, pending per-line audit
          ...
          {mode === 'choose' && (
            <>
              <button
                ...
                disabled={busy}
                className="w-full py-3 rounded-xl font-bold text-sm bg-white text-ink-primary hover:bg-slate-100 disabled:opacity-50 flex items-center justify-center gap-2" /* theme-ok: legacy hardcoded color, pending audit */
              >
              ...
              <button
                ...
                onClick={handleApple}
                disabled={busy}
                className="w-full py-3 rounded-xl font-bold text-sm bg-black text-white ring-1 ring-line-default/20 hover:bg-surface-elevated disabled:opacity-50 flex items-center justify-center gap-2" /* theme-ok: legacy hardcoded color, pending audit */
              >
              ...
              <div className="flex items-center gap-3 my-2">
                ...
                <span className="text-[10px] font-bold uppercase tracking-widest text-ink-primary/65">or</span>
                <div className="flex-1 h-px bg-line-default/10" />
              </div>
              <button
                type="button"
                onClick={() => setMode('email-signup')}
                className="w-full py-3 rounded-xl font-bold text-sm bg-brand-primary hover:bg-brand-primary text-white" /* theme-ok: legacy hardcoded color, pending audit */
              >
          ...
          {(mode === 'email-signin' || mode === 'email-signup') && (
            <>
              ...
              <button
                ...
                className="w-full py-3 rounded-xl font-bold text-sm text-white bg-brand-primary hover:bg-brand-primary disabled:opacity-50" /* theme-ok: legacy hardcoded color, pending audit */
              >
