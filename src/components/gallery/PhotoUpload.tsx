        ...
        <div className="sticky top-0 bg-white border-b border-gray-200 px-6 py-4">  // theme-ok: legacy hardcoded color, pending per-line audit
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="text-ink-primary/55 hover:text-ink-primary/80 transition-colors duration-200 disabled:opacity-50"
            >
        ...
        <div className="p-6">
          ...
          {!selectedFiles.length && (
            <div className="border-2 border-dashed border-gray-300 rounded-lg p-8 text-center">  // theme-ok: legacy hardcoded color, pending per-line audit
              ...
              >
                <svg className="w-12 h-12 text-ink-primary/55 mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M7 16a4 4 0 01-.88-7.903A5 5 0 1115.9 6L16 6a5 5 0 011 9.9M15 13l-3-3m0 0l-3 3m3-3v12" />
                </svg>
                <span className="text-lg font-medium text-ink-primary mb-2">Select Photos</span>
                <span className="text-sm text-ink-primary/65">Choose up to 10 images (JPG, PNG, GIF)</span>
              </label>
            </div>
          )}
          ...
          {selectedFiles.length > 0 && (
            <div className="space-y-6">
              ...
              <div className="space-y-4">
                <h3 className="text-lg font-medium text-ink-primary">Add Captions</h3>
                {selectedFiles.map((file, index) => (
                  <div key={file.name}>
                    <label className="block text-sm font-medium text-ink-primary/90 mb-1">
                      {file.name}
                    </label>
                    <input
                      type="text"
              ...
              <div className="space-y-3">
                <h3 className="text-lg font-medium text-ink-primary">Add Tags</h3>
