          ...
          {mode === 'choose' && (
            <>
              <button
                ...
                disabled={busy}
                className="w-full py-3 rounded-xl font-bold text-sm bg-white text-ink-primary hover:bg-slate-100 disabled:opacity-50 flex items-center justify-center gap-2 theme-ok"
              >
              ...
              <button
                ...
                onClick={handleApple}
                disabled={busy}
                className="w-full py-3 rounded-xl font-bold text-sm bg-black text-white ring-1 ring-line-default/20 hover:bg-surface-elevated disabled:opacity-50 flex items-center justify-center gap-2 theme-ok"
              >
              ...
              <button
                ...
                className="w-full py-3 rounded-xl font-bold text-sm bg-brand-primary hover:bg-brand-primary text-white"
              >
          ...
          {(mode === 'email-signin' || mode === 'email-signup') && (
            <>
              ...
              <button
                ...
                className="w-full py-3 rounded-xl font-bold text-sm text-white bg-brand-primary hover:bg-brand-primary disabled:opacity-50"
              >
