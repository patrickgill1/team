                      ...
                      {isUserCoach && (
                        linkingUid === entry.user.uid ? (
                          ...
                          <button
                            ...
                            className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-surface-elevated text-ink-primary font-bold text-sm shadow hover:scale-105 transition"
                          >
                            Link to Player
                          </button>
                        )
